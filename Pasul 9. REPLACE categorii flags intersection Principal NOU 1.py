    ...
    for ro_file, ro_links in ro_files_data.items():
        ...
        if expected_en_filename in en_to_ro_mapping:
            ...
            if true_owner != ro_file:
                ...
                continue  # NU procesăm mai departe fișierele unice
...
# 🟡 DOAR AFIȘEAZĂ (NU MODIFICĂ) fișierele RO unice
if unique_ro_files:
    print(f"\n🟡 FIȘIERE RO UNICE (fără corespondent real în EN):")
    print("🚫 ACESTE FIȘIERE NU VOR FI MODIFICATE!")
    print("=" * 80)
...
# 🔧 AFIȘEAZĂ ȘI REPARĂ fișierele cu probleme regulate
if issues_found:
    print(f"\n🔍 VERIFICARE COMPLETĂ - PROBLEME REGULATE!")
    print("✅ ACESTE FIȘIERE VOR FI REPARATE AUTOMAT!")
    print("=" * 80)
